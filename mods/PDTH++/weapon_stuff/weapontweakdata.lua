...
-- primary shotgun overhaul 大喷大修
	...
	self.r870_shotgun.bodyshot_multiplier = 0.4
end)
...
-- ak overhaul AK大修
    ...
    self.ak47.AMMO_PICKUP = { 1.5, 3.4 }
	self.ak47.EXTRA_PICKUP = { 0.3, 0.6 }
	self.ak47.spread.standing = 1.35
	self.ak47.spread.crouching = 1
	self.ak47.spread.steelsight = 0.23
	self.ak47.spread.moving_standing = 3.8
	self.ak47.spread.moving_crouching = 1.75
	self.ak47.crosshair.standing.offset = 0.16
	self.ak47.crosshair.standing.moving_offset = 0.5
	self.ak47.crosshair.standing.kick_offset = 0.225
	self.ak47.crosshair.crouching.offset = 0.08
	self.ak47.crosshair.crouching.moving_offset = 0.23
	self.ak47.crosshair.crouching.kick_offset = 0.125
    self.ak47.kick.v.standing = 1.5
    self.ak47.kick.v.crouching = 1.2
    self.ak47.kick.v.steelsight = 0.63
    self.ak47.kick.h.standing = 2
    self.ak47.kick.h.crouching = 1.5
    self.ak47.kick.h.steelsight = 0.55
	self.ak47.headshot_multiplier = 1.05
	self.ak47.ads_speed = 1
	self.ak47.reload_speed = 1.12
	self.ak47.bodyshot_multiplier = 0.5
end)
...
-- amcar-4 overhaul M4大修
	...
	self.test_raycast_weapon.EXTRA_PICKUP = { 0.6, 1.4 }
    ...
    self.test_raycast_weapon.spread.crouching = 0.68
    self.test_raycast_weapon.spread.steelsight = 0.3
	self.test_raycast_weapon.spread.moving_standing = 3.9
	self.test_raycast_weapon.spread.moving_crouching = 2.75
	self.test_raycast_weapon.crosshair.standing.offset = 0.12
    self.test_raycast_weapon.crosshair.standing.moving_offset = 0.423
    self.test_raycast_weapon.crosshair.standing.kick_offset = 0.1333
    self.test_raycast_weapon.crosshair.crouching.offset = 0.055
	self.test_raycast_weapon.crosshair.crouching.moving_offset = 0.253
	self.test_raycast_weapon.crosshair.crouching.kick_offset = 0.1333
	self.test_raycast_weapon.kick.v.standing = 1
	self.test_raycast_weapon.kick.v.crouching = 0.6
	self.test_raycast_weapon.kick.v.steelsight = 0.3
	self.test_raycast_weapon.kick.h.standing = 0.4
	self.test_raycast_weapon.kick.h.crouching = 0.2
...
-- m308 overhaul m308大修
	...
	self.m14.EXTRA_PICKUP = { 0.2, 0.7 }
	self.m14.DAMAGE = 4
	self.m14.CLIP_AMMO_MAX = 12
	self.m14.spread.steelsight = 0.01
	self.m14.spread.standing = 0.7
    self.m14.spread.crouching = 0.5
    self.m14.spread.moving_standing = 2.5
    self.m14.spread.moving_crouching = 2
	self.m14.crosshair.standing.offset = 0.0553
	self.m14.crosshair.standing.moving_offset = 0.2
	self.m14.crosshair.standing.kick_offset = 0.6
	self.m14.crosshair.crouching.offset = 0.03
	self.m14.crosshair.crouching.moving_offset = 0.16
	self.m14.crosshair.crouching.kick_offset = 0.4
	self.m14.single.fire_rate = 0.15
	self.m14.firerate_multiplier = 1.25
	self.m14.kick.v.standing = 3.45
	self.m14.kick.v.crouching = 2.7
	self.m14.kick.v.steelsight = 0.7
	self.m14.kick.h.standing = 1.9
	self.m14.kick.h.crouching = 1
	self.m14.kick.h.steelsight = 0.2
	self.m14.headshot_multiplier = 2
	self.m14.ads_speed = 1
	self.m14.reload_speed = 0.95
	self.m14.movement_speed_multiplier = 1
	self.m14.bodyshot_multiplier = 3
end)
...
-- lmg overhaul 机枪大修
	...
	self.hk21.EXTRA_PICKUP = {0.5, 1.2}
	self.hk21.DAMAGE = 4
...
-- mp5 overhaul mp5大修
    ...
    self.mp5.spread.crouching = 0.68
    self.mp5.spread.steelsight = 0.3
    self.mp5.spread.moving_standing = 3.9
    self.mp5.spread.moving_crouching = 2.75  --It's typically a m4 clone for its spread
    ...
    self.mp5.crosshair.standing.offset = 0.12
    self.mp5.crosshair.standing.moving_offset = 0.423
    self.mp5.crosshair.standing.kick_offset = 0.08
    self.mp5.crosshair.crouching.offset = 0.055
	self.mp5.crosshair.crouching.moving_offset = 0.253
	self.mp5.crosshair.crouching.kick_offset = 0.08
	self.mp5.headshot_multiplier = 1.3
...
-- mark 11 overhaul mk11大修
	...
	self.mac11.EXTRA_PICKUP = { 0.8, 0.7 }
...
-- loco overhaul 火车头大修
	...
	self.mossberg.EXTRA_PICKUP = { 0.3, 0.5 }
	...
	self.mossberg.headshot_multiplier = 0.7
...
-- gl40 overhaul 榴弹大修
	...
	self.m79.pickup_disabled = true
	self.m79.headshot_multiplier = 1
...
-- b9-s overhaul b9大修
    ...
    self.beretta92.crosshair.standing.moving_offset = 0.0889
...
-- crosskill .45 overhaul C45大修
    ...
    self.c45.spread.standing = 1.5
    self.c45.spread.crouching = 0.9
    self.c45.spread.steelsight = 0.55
    self.c45.spread.moving_standing = 2
    self.c45.spread.moving_crouching = 1.7
    ...
    self.c45.crosshair.standing.offset = 0.11
    self.c45.crosshair.standing.moving_offset = 0.189
    self.c45.crosshair.standing.kick_offset = 0.3
    self.c45.crosshair.crouching.offset = 0.08
    self.c45.crosshair.crouching.moving_offset = 0.153
    self.c45.crosshair.crouching.kick_offset = 0.4
	self.c45.headshot_multiplier = 1.2
	self.c45.ads_speed = 1.42
	self.c45.reload_speed = 1.5
	self.c45.bodyshot_multiplier = 1
end)
...
-- bronco overhaul 左轮大修
	...
	self.raging_bull.EXTRA_PICKUP = { 0.2, 0.45 }
    ...
    self.raging_bull.spread.moving_crouching = 1
    ...
    self.raging_bull.crosshair.standing.offset = 0.085
...
--stryk overhaul 自动手枪大修
	...
	self.glock.EXTRA_PICKUP = { 1.2, 0.5 }
    self.glock.DAMAGE = 2
	...
	self.glock.headshot_multiplier = 0.9
	self.glock.ads_speed = 1.42
	self.glock.reload_speed = 1.3
	self.glock.bodyshot_multiplier = 0.5
end)
...
module:post_hook(WeaponTweakData, "_init_data_shield_pistol_npc", function(self)
    self.shield_pistol_npc.DAMAGE = 0.8
end)
