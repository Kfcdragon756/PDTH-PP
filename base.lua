...
module:hook("OnModuleLoading", "load_mutators", function(module)
	...
	if MutatorHelper.setup_mutator(module, "expert_mode", mutator_availability, nil, true) then
		...
		module:hook_post_require(
			...
			"mutator/expert_mode/actionspooc"
		)
	...
	mutator_availability =
		{ overkill = { levels = { heat_street = true } }, overkill_145 = { levels = { heat_street = true } } }
	...
	mutator_availability = {
		...
		overkill = {},
		overkill_145 = {},
		_conflicts = { "zhouji", "no_time_for_searching", "kaboom", "exercised_cops", "combine_assault" },
	}
